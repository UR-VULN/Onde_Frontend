...
const DEMO_TYPES: ErrorType[] = ['401', '403', '404', '500', '503'];

const DEMO_LABELS: Record<ErrorType, string> = {
  '401': '🔐 401 Unauthorized',
  '403': '⛔ 403 Forbidden',
  '404': '🚫 404 Not Found',
  '500': '🔥 500 Server Error',
  '503': '🛠️ 503 Maintenance',
};

const MASCOT_STYLE: React.CSSProperties = {
  width: '320px',
  height: '320px',
  objectFit: 'contain',
        ...
        return (
          <div className="flex flex-col items-center text-center gap-14 animate-[fadeIn_0.35s_ease]">
            <div className="relative flex items-center justify-center w-full" style={{ minHeight: '280px' }}>
              <span
                className="select-none font-black leading-none bg-gradient-to-br from-violet-500 via-purple-500 to-fuchsia-400 bg-clip-text text-transparent"
                style={{ fontSize: 'clamp(7rem, 18vw, 12rem)', opacity: 0.12, letterSpacing: '-0.05em' }}
              >
                401
              </span>
              <div className="absolute inset-0 flex items-center justify-center">
                <img src={error401} alt="401 마스코트" style={MASCOT_STYLE} />
              </div>
            </div>

            <div className="space-y-6 px-2">
              <div className="inline-block bg-violet-50 border border-violet-200/60 text-violet-600 text-xs font-black px-4 py-1.5 rounded-full tracking-widest uppercase">
                401 · Unauthorized
              </div>
              ...
              <p className="text-slate-500 font-medium text-base md:text-lg leading-relaxed max-w-lg mx-auto">
                이 페이지는 ONDE 회원만 이용할 수 있습니다.<br />
                로그인 후 다시 시도하시면 정상적으로 이용하실 수 있어요.
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 w-full max-w-md">
              ...
              >
                <i className="fa-solid fa-right-to-bracket mr-2"></i> 로그인하기
              </button>
              <button
                type="button"
              ...
              >
                <i className="fa-solid fa-house mr-2"></i> 메인 홈으로
              </button>
            </div>
          </div>
        );
      ...
      case '403':
        return (
          <div className="flex flex-col items-center text-center gap-14 animate-[fadeIn_0.35s_ease]">
            <div className="relative flex items-center justify-center w-full" style={{ minHeight: '280px' }}>
              <span
                className="select-none font-black leading-none bg-gradient-to-br from-emerald-500 via-teal-500 to-cyan-400 bg-clip-text text-transparent"
                style={{ fontSize: 'clamp(7rem, 18vw, 12rem)', opacity: 0.12, letterSpacing: '-0.05em' }}
              >
                403
              </span>
              <div className="absolute inset-0 flex items-center justify-center">
                <img
                  src={error403}
                  alt="403 마스코트"
                  style={{ ...MASCOT_STYLE, filter: 'drop-shadow(0 12px 32px rgba(0,0,0,0.14)) hue-rotate(-8deg)' }}
                />
              </div>
            </div>

            <div className="space-y-6 px-2">
              <div className="inline-block bg-emerald-50 border border-emerald-200/60 text-emerald-600 text-xs font-black px-4 py-1.5 rounded-full tracking-widest uppercase">
                403 · Forbidden
              </div>
              <h2 className="text-4xl md:text-5xl font-black text-slate-800 tracking-tight leading-tight">
                접근 권한이 없어요
              ...
              <p className="text-slate-500 font-medium text-base md:text-lg leading-relaxed max-w-lg mx-auto">
                이 기능은 판매자·관리자 등 허용된 계정만 이용할 수 있습니다.<br />
                권한이 필요하시면 ONDE 고객센터로 문의해 주세요.
              </p>
            </div>
        ...
        return (
          <div className="flex flex-col items-center text-center gap-14 animate-[fadeIn_0.35s_ease]">
            <div className="relative flex items-center justify-center w-full" style={{ minHeight: '280px' }}>
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <img src={error404} alt="404 마스코트" style={MASCOT_STYLE} />
              </div>
            </div>
            ...
            <div className="relative flex items-center justify-center w-full" style={{ minHeight: '280px' }}>
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <img
                  src={error500}
                  alt="500 마스코트"
                  style={{ ...MASCOT_STYLE, filter: 'drop-shadow(0 12px 32px rgba(0,0,0,0.14)) grayscale(30%)' }}
                />
              </div>
            </div>
            ...
            <div className="relative flex items-center justify-center w-full" style={{ minHeight: '280px' }}>
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <img
                  src={error503}
                  alt="점검 마스코트"
                  style={{ ...MASCOT_STYLE, filter: 'drop-shadow(0 12px 32px rgba(0,0,0,0.14)) sepia(20%)' }}
                />
              </div>
            </div>
